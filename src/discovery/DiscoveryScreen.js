  ...
  render() {
    ...
    const navigation = (
      <View style={styles.navigation}>
        ...
        <TouchableHighlight style={ styles.iconContainer } onPress={ () => this.props.discovery.setType('object/service') } underlayColor='#fff'>
          <Icon
            name="store"
            style={[styles.icon, this.props.discovery.type == 'object/service' ? styles.iconActive : null ]}
            size={ 20 }
            />
        </TouchableHighlight>
      </View>
  ...
  renderService = (row) => {
    return (
      <View style={styles.serviceCardContainer}>
        <ServiceCard entity={row.item} navigation={this.props.navigation} />
      </View>
    );
  }
