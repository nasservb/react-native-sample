    ...
    if (newsfeed.list.loaded && !newsfeed.list.refreshing) {
      if (this.props.emptyMessage) {
        ...
        empty = (
          <View style={ComponentsStyle.emptyComponentContainer}>
            <View style={ComponentsStyle.emptyComponent}>
              ...
              <Text style={ComponentsStyle.emptyComponentMessage}>صفحه ی شما خالی است</Text>
              {design}
              <Text 
                style={ComponentsStyle.emptyComponentLink}
        ...
        empty = (
          <View style={ComponentsStyle.emptyComponentContainer}>
            <View style={ComponentsStyle.emptyComponent}>
              <Text style={ComponentsStyle.emptyComponentMessage}>چیزی برای نمایش وجود ندارد</Text>
            </View>
          </View>);
      }
    }
