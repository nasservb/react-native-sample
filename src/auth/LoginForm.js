    ...
    return (
      <KeyboardAvoidingView behavior='padding'>
        ...
        <View style={[CommonStyle.rowJustifyEnd, CommonStyle.paddingTop3x]}>
          <Text style={[CommonStyle.colorWhite, ComponentsStyle.link]} onPress={this.onForgotPress}>فراموشی رمز</Text>
        </View>
      </KeyboardAvoidingView>
    );
  }
        ...
        .catch(err => {
          err.json()
            .then(errJson => {
              ...
              this.setState({ msg: errJson.message || 'خطا' });
            })
            .catch(err => {
              this.setState({ msg: 'خطا، لطفآ دوباره تلاش کنید.' });
            });
        });
    }
  }
