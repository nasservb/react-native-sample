...
import ServicesListScreen from './src/services/ServicesListScreen';
import ServicesViewScreen from './src/services/ServicesViewScreen';
import ServiceCreateScreen from './src/services/ServiceCreateScreen';
...
const Stack = StackNavigator({
  ...
  ServiceCreate: {
    screen: ServiceCreateScreen
  },  
  ServicesView: {
    screen: ServicesViewScreen,
    path: 'service/view/:guid',
  },
  BlogList: {
